/*
**	pager menu by Tsath 2020 for Nuke Mudlib
**
*/
...
void init_guild_modules(object *modules)
{
   ...
   foreach (object module in modules)
   {
      ...
      class menu_item mi = new_menu_item(capitalize(guild) + " pager module", gm, module->query_letter());
...
void create(int level)
{
   ...
   toplevel = new_menu("[-- Freamon Electronics Ltd. Pager                   -----]");
